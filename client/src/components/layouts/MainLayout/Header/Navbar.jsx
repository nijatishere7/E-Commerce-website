  ...
  return (
    ...
    >
      <div className="flex items-center">
        ...
        <Link
          className="py-7.5 px-4 text-[13px] max-xl:px-2 max-lg:hidden text-[#222529] font-semibold flex gap-0.5 items-center"
          to="/shop"
        >
          SHOP
          <IoIosArrowDown />
        ...
        <Link
          className="py-7.5 px-4 text-[13px] max-xl:hidden text-[#222529] font-semibold"
          to="/"
        >
          FEATURES
        </Link>
        ...
        <Link
          className="py-7.5 max-[1460px]:hidden px-4 text-[13px] text-[#222529] font-semibold"
          to="/about"
        >
          ABOUT
        </Link>
